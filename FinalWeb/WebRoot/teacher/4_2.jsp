...
<head>
    <meta charset="UTF-8">
    <title>Teacher-examination paper management</title>
    <!-- css 文件 -->
    ...
    <link rel="stylesheet" href="mainmenu/css/Teacher-examination.css">
        ...
        <div class="inner-wrap">
            ...
            <nav class="top-bar" data-topbar data-options="is_hover: false">
                ...
                <section class="top-bar-section">
                    <ul class="left">
                        ...
                        <a href="#">测试管理</a>
                        <ul class="dropdown">
                            <li ><a href="4_1.jspl">题库管理</a></li>
                            <li class="active"><a href="4_2.jsp">试卷管理</a></li>
            ...
            <div id="rollbook"  class="responsive" style="background: url(mainmenu/img/bg1.jpg); ">
                <div class="information">
                    <h4><img src="mainmenu/img/图书馆.png">试卷管理</h4>
